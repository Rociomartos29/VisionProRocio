...
public struct HerosData: Codable, Identifiable , Hashable {
    ...
    public init(id: UUID, favorite: Bool, description: String, photo: String, name: String, transformations: [HerosTransformationsModelResponse], id3DModel: String = "") {
